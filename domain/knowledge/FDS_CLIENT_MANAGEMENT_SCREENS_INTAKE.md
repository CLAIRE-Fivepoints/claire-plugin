...
description: "TFI One FDS Client Management — Section III: Intake/Admission, Client Search, Face Sheet, Client Information, Documents, Placement History, Characteristics, Worker Assignment"
keywords: [fds, client-management, tfi-one, intake, client-search, face-sheet, client-information, placement-history, characteristics, worker-assignment]
